...
{	clear
	...
	echo "|                                                      |"
	echo "|                                                      |"
	echo "| Αυτό η εφαρμογή θα κάνει εγγραφή σε βίνετο το desktop|"
	echo "|    σας και είναι ιδανικό για tutorials μεσω video    |"
	echo "|                                                      |"  
	echo "|______________________________________________________|"
	echo
}
...
audio()
{
	...
	echo "Ποιά διεπαφή ήχου θες να ηχογραφίσεις ;"
	echo
...
audio_codec()
{
	...
	echo "Ποιον κωδικοποιητή ήχου θέλεις να χρησιμοποιήσεις ;"
	echo
	echo "1. Lossless"
	echo "2. mp3 Lame"
...
video_codec()
{
	...
	echo "Ποιον κωδικοποιητή Video θέλεις να χρησιμοποιήσεις ;"
	echo
	echo "1. H.264"
	echo "2. MPEG2"
	echo "3. MPEG4"
...
intro
echo "Η εντολή που χρειάζεσαι είναι:"
echo
